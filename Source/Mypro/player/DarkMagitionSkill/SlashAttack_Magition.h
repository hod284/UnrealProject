...
UCLASS()
class MYPRO_API ASlashAttack_Magition : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ASlashAttack_Magition();
...
protected:
	...
	// ¿À¹ö·¦
	UFUNCTION()
	void OnCapsuleBeginOverlap_Slash_Magition(
	...
	// ¿À¹ö·¦ ³¡
	UFUNCTION()
	void OnCapsuleEndOverlap_Slash_Magition(
		UPrimitiveComponent* OverlappedComp,
		AActor* OtherActor,
		UPrimitiveComponent* OtherComp,
		int32 OtherBodyIndex);
