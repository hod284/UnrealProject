...
#include "Skill2_Actor.generated.h"

UCLASS()
class MYPRO_API ASkill2_Actor : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Ãæµ¹
	UFUNCTION()
	void OnHit_Skil2(UPrimitiveComponent* HitComp, AActor* OtherActor,
		UPrimitiveComponent* OtherComp, FVector NormalImpulse,
		const FHitResult& Hit);
	// ¿À¹ö·¦
	UFUNCTION()
	void OnCapsuleBeginOverlap_Skil2(
	...
	// ¿À¹ö·¦ ³¡
	UFUNCTION()
	void OnCapsuleEndOverlap_Skil2(
		UPrimitiveComponent* OverlappedComp,
		AActor* OtherActor,
		UPrimitiveComponent* OtherComp,
		int32 OtherBodyIndex);
