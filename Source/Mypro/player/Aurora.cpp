...
void AAurora::Server_NAttack_Implementation(FVector velocity, ECollisionChannel atchannel)
{
    Multicast_NAttack(velocity, atchannel);
}

void AAurora::Multicast_NAttack_Implementation(FVector velocity, ECollisionChannel atchannel)
{
    AttackWeapon(velocity, atchannel);
}

void AAurora::AttackWeapon(FVector velocity, ECollisionChannel atchannel)
{
