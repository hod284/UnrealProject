...
AAction4_Monster::AAction4_Monster()
{
	...
	// ������ �κ�Ʈ Ȱ��ȭ
	BoxColider1->SetGenerateOverlapEvents(true); // �����ϰ� �ѵα�
	...
	// ������ �κ�Ʈ Ȱ��ȭ
	BoxColider2->SetGenerateOverlapEvents(true); // �����ϰ� �ѵα�
	...
	// ������ �κ�Ʈ Ȱ��ȭ
	BoxColider3->SetGenerateOverlapEvents(true); // �����ϰ� �ѵα�
	...
	// ������ �κ�Ʈ Ȱ��ȭ
	BoxColider4->SetGenerateOverlapEvents(true); // �����ϰ� �ѵα�
